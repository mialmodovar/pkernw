 ...
 *
 * Phones are the exception — it lands on the action buttons there.
 */
export default function BuildStamp() {
  return (
    <span
      title="Build this page was served from"
      className="hidden md:inline fixed bottom-0.5 left-1/2 -translate-x-1/2 z-50 pointer-events-none select-none
