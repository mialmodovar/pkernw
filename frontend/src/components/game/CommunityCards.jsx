...
function CardView({ card: str, delay, winning }) {
  ...
  return (
    <div className={`w-[clamp(2rem,4.5vw,2.75rem)] h-[clamp(2.9rem,6.5vw,4rem)] rounded flex flex-col items-center justify-center font-bold animate-card-deal ${CARD_FACE} ${winning ? CARD_WINNING : ""}`}
